package bsu.rfe.java.group8.laba3.Kalitin.varA4;
...
public class MainFrame extends JFrame {
    ...
    public MainFrame(Double[] coefficients) {
        ...
        Action refereceOboutMe = new AbstractAction("Справка") {
            @Override
            public void actionPerformed(ActionEvent event) {
                JOptionPane.showMessageDialog(MainFrame.this, "Программа завершена успешно!", "Справка", JOptionPane.INFORMATION_MESSAGE);
            }
        };
